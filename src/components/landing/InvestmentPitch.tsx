      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="relative">
          <Card className={cn(
            ...
            <div className="w-full flex flex-col md:flex-row gap-8 lg:gap-24">
              <div className="flex-1 space-y-8 md:space-y-12 order-2 md:order-1 animate-in slide-in-from-left duration-700">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
                        ...
                        <div className="flex flex-col justify-center gap-4">
                          <div className="flex items-center justify-between">
                            <Label className="text-[10px] md:text-xs font-black uppercase tracking-[0.2em] text-muted-foreground">Monthly Compounding</Label>
                          ...
                          <div className="p-3 md:p-4 rounded-xl bg-primary/10 border border-primary/20 text-center">
                            ...
                            <span className="text-lg md:text-xl font-black italic text-primary">{monthlyRoi}%</span>
                          </div>
                        </div>
                      </div>
                ...
                {current.isGlobalImpact && (
                  <div className="space-y-8 p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] bg-white/5 border border-primary/20 gold-shimmer relative overflow-hidden">
                    <div className="space-y-2">
                      <Label className="text-xs font-black uppercase tracking-[0.4em] text-primary">Total Paid to Investors</Label>
                      <p className="text-3xl md:text-7xl font-black italic tracking-tighter tabular-nums v56-gradient-text">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 pt-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xl md:text-2xl font-black italic text-white">{activeInvestors.toLocaleString()}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl md:rounded-2xl bg-primary/10 flex items-center justify-center border border-primary/20">
                        ...
                        <div>
                          ...
                          <p className="text-xl md:text-2xl font-black italic text-white">140+ Countries</p>
                        </div>
                      </div>
                    </div>
                  </div>

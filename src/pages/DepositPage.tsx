import { CheckCircle, Copy, Loader2, Ticket, Check, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold v56-gradient-text">Deposit Funds</h1>
                ...
                >
                  <div className="aspect-video bg-muted rounded-lg flex items-center justify-center overflow-hidden">
                    {tutorial.thumbnail_url ? (
                      <img loading="lazy" decoding="async" src={tutorial.thumbnail_url} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                    ) : (
